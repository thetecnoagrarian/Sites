...
test('TTA post detail emits no post image markup for zero images', () => {
...
test('TTA post detail renders exactly one structured image without a carousel', () => {
...
test('TTA post detail preserves the structured multi-image carousel', () => {
  const html = renderPost(
