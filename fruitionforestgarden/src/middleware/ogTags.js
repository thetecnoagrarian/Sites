...
function buildOgTags(post) {
  ...
  const desc = post.description || (post.body ? post.body.substring(0, 160) + '...' : 'A blog about our adventure building our homestead on a bare 20 acres in Michigan\'s Upper Peninsula.');
